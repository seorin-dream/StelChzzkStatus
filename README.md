...
<p>Workers에서 작동할 때 Variables에 CHZZK_COOKIES, TELEGRAM_TOKEN을 만들고 값은 위와 동일하게 지정하면 됩니다.</p>

<h2>목적</h2>
<p>Python과 Telegram Bot이 어떤 식으로 동작하나 궁금해서 여러 자료를 참고하여 학습용으로 만든 봇입니다.</p>
<p>이젠 내가 쓸려고 만들었습니다.</p>

<h2>향후 수정할 내용</h2>
<p>중복된 코드가 상당히 많아서 하나의 함수로 정리를 하려고 합니다.</p>
<p>치지직 채널을 하드코딩 해두었는데 사용자 입력을 받아 저장해서 사용할 수 있는지 검토 중입니다.</p>
